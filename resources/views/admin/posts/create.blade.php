					...
					<div class="demo-masked-input">
						<div class="row clearfix">
							...
							<div class="col-md-12">
								...
								<textarea id="my-editor" name="summary" class="form-control" rows="5">{!! old('summary') !!}</textarea>
							...
							<div class="col-md-12">
									...
									<div class="input-group">
										<span class="input-group-addon">
											<i class="material-icons">link</i></span>
										<div class="form-line">
											<input type="text" name="seotitle" class="form-control input-lg" placeholder="SEO TITLE" required>
										</div>
										<!-- <div class="help-info">Starts with http://, https://, ftp:// etc</div> -->
									</div>
								</div>
								<div class="col-md-12">
										...
										<div class="input-group">
											<span class="input-group-addon">
												<i class="material-icons">link</i></span>
											<div class="form-line">
												<input type="text" name="seodescrip" class="form-control input-lg" placeholder="SEO Descriptption"  required>
											</div>
											<!-- <div class="help-info">Starts with http://, https://, ftp:// etc</div> -->
										</div>
									</div>
				...
				<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
					<div class="demo-masked-input">
						...
						<div class="col-md-12" style="margin-bottom: 10px">
							...
							{!! Form::select('tags[]', $tags,[], array('class' => 'js-example-basic-multiple','multiple','style="width: 100%"'))!!}
